<template>
    <v-container>
        <v-card>
            ...
            <h2 class="text-md-center">Data Pekerja</h2>
    ...
    <v-dialog v-model="dialog" persistent max-width="600px">
        <v-card>
            <v-card-title>
                <span class="headline">Data Pemesanan</span>
                </v-card-title>
            <v-card-text>
                <v-container>
                    <v-row>
                        ...
                        <v-col cols="12">
                            <v-text-field label="Jumlah" v-model="form.amount" required></v-text-field>
                        </v-col>
                        <v-col cols="12">
                            <v-text-field label="Tanggal" v-model="form.created_at" required></v-text-field>
                        </v-col>
                    </v-row>
                </v-container>
        ...
        return {
            ...
            methods: {
                ...
                sendData() {
                    ...
                    this.sparepart.append('date',this.form.created_at);
                    var uri=this.$apiUrl + '/sparepart'
                    this.load=true 
